...
<div class=""> 
<form method="post" action="empprofileaction.php" enctype="multipart/form-data">
...
<div class="col-xs-12 col-sm-5 form-group">
  ...
  <div class="row"> 
      ...
      <input type="email" class="form-control" id="emailid" placeholder="Email Id" name="emailid" value='<?php echo $row['emailid'] ?>' readonly>
          ...
          <input type="text" class="form-control" id="password" placeholder="Password" name="password" value='<?php echo $row['password'] ?>' minlength="6" maxlength="10" required>
                 </div>
         </div> 
        </div>
