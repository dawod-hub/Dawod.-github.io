...
<?php
            if(isset($_GET['error'])==true){
                if($_GET['error']==1){ 
                echo "<b style='color:red'>*&nbsp; Your item alreary existed in cart. </b>";       
                }
                elseif($_GET['error']==2){
                echo "<b style='color:red'>*&nbsp; Your items is not successfully added in cart . </b>";
                }
                elseif($_GET['error']==3){  
                echo "<b style='color:#3333ff'>*&nbsp; Your itemss is successfully added in cart. </b>";       
                }
            }
            ?>
</center>  
...
include "connection.php";
    ...
    $sql = "SELECT a.id, i.itemname, i.itemimage, i.itemprice, i.itemdesc, c.categoryname, a.itemstatus FROM assignitems a, branch b, category c, items i WHERE a.branchid=b.id AND a.catid=c.id AND a.itemid=i.id AND a.itemstatus='Available' AND a.branchid='$bid' AND a.catid='$cid' ";
...
<tr>
<td><br>
   <center><a href="viewitemsaction.php?aid=<?php echo $row['id'] ?> & usermailid=<?php echo $email ?> & bid=<?php echo $bid ?> & cid=<?php echo $cid ?>" class="btn btn-default btn-sm">Add cart</a></center>
</td>
</tr>
...
$('.viewmodal').click(function () {
    ...
    $('#is').text($(this).closest("tr").find('td:eq(5)').text());
