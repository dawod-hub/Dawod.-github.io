...
<br><br>
 ...
 <div class="log">
<form method="POST" action="admincomposeaction.php" enctype="multipart/form-data" >
...
$sql=mysqli_query($db,"SELECT b.branchname, b.brancharea, r.fullname, b.empmailid FROM register r, branch b WHERE r.emailid=b.empmailid ");
   
while ($row=mysqli_fetch_array($sql)) { ?>

  <option value=<?php echo $row['empmailid'];?>><?php echo $row['branchname'] ." (". $row['brancharea'] .")" ;?></option>
  <?php } ?>
</select>
</div>
</div>
...
<td>
    <a href="adminreply.php?id=<?php echo  $row['id'] ?>" class="btn btn-warning btn-sm">Reply</a>
</td>
