  ...
  <div class="col-xs-12 col-sm-6 form-group">
      ...
      <input type="email" class="form-control" id="emailid" placeholder="Email Id" name="emailid" value='<?php echo $email ?>' readonly>
       ...
       <div class="row">
              ...
              <input type="password" class="form-control" id="newpassword" placeholder="New Password" name="newpassword" minlength="5" maxlength="10" required>
               </div>
            </div>
           </div>
       ...
       <div class="row">
                 ...
                 <div class="input-group">
                  <span class="input-group-addon"><small><i class ="fa fa-asterisk"></i></small></span>
              <input type="password" class="form-control" id="confirmpassword" placeholder="Confirm Password" name="confirmpassword" minlength="5" maxlength="10" required>
               </div>
            </div>
          </div>       
